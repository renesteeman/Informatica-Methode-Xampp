...
<body>
  ...
  <div class="bar-par-overview">
    ...
    <div class="theorie-content">
			...
			<p>SQL wordt meestal in combinatie gebruikt met een programmeertaal, zoals voor deze website gedaan is. In dit geval is PHP gecombineerd SQL en hiermee kan bijvoorbeeld ingelogd worden en kan de docent een overzicht zien van de klassen.</p>
    ...
    <div class="bar-s">
        ...
        <div class="theorie-content">
        	<ol>
						<li>Ordert ORDER BY data standard van klein naar groot of groot naar klein?</li>
