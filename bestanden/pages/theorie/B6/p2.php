...
<body>
	...
	<div class="theorie">
		...
		<div class="theorie-content">
			...
			<p>Op het moment dat je de basis van het ontwerp af hebt, dus als je: de structuur, de kleuren, het lettertype en dergelijken hebt vastgesteld, kun je een gedetailleerd ontwerp maken. Het is vaak handig om dit digitaal te maken, aangezien je dan makkelijk dingen kunt aanpassen en vaak meer detail kan weergeven. Een programma dat hier handig voor is is inkscape (<a href="https://inkscape.org/">https://inkscape.org/</a>), hiermee kun je SVG's (scalable vector graphics) maken. Het voordeel hiervan is dat alles als objecten wordt gezien en je ze kan blijven verplaatsen en aanpassen, bij een programma zoals paint.net zou het veel moeilijker zijn om halverwege de structuur aan te passen. Het nadeel van inkscape is dat het vrij lastig kan zijn om mee te beginnen, de UX had beter gekund. Als je de basis van inkscape wilt leren kun je op <a href="https://inkscape.org/doc/tutorials/basic/tutorial-basic.html">https://inkscape.org/doc/tutorials/basic/tutorial-basic.html</a> beginnen. Dit is een voorbeeld van een ontwerp in inkscape.</p>
		...
		<div class="theorie-content">
			<ol>
				<li>Wat probeer je weer te geven met een wireframe?</li>
				<li>
					Maak zelf een wireframe, eventueel van een bekende website.
				</li>
			</ol>
		</div>
		...
		<div class="theorie-content theorie-answers">
			<ol>
				<li>De structuur van een pagina.</li>
				<li>-</li>
			</ol>
		</div>
	</div>
