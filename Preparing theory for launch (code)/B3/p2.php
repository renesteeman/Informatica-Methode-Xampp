...
&lt;/html>
			...
			<p>Je kunt testen of jouw include werkt door in het JS bestand #CODE alert('test'); te plaatsen. Dit zou moeten zorgen voor een pop-up bericht.</p>
			...
			<pre>
				<code>
					Content = document.getElementById(“formulier”).innerText;
				</code>
			</pre>
			...
			<pre>
				<code>
					document.getElementById(“element”).classList.add(‘Class’);
				</code>
			</pre>
