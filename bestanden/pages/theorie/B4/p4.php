...
<body>
  ...
  <div class="theorie">
    ...
    <div class="theorie-content">
  		...
  		<p>SQL wordt meestal in combinatie gebruikt met een programmeertaal, zoals voor deze website gedaan is. In dit geval is PHP gecombineerd met SQL en hiermee kan bijvoorbeeld ingelogd worden en kan de docent een overzicht zien van de klassen.</p>
