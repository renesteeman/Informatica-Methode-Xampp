...
<body>
	...
	<div class="theorie">
		...
		<div class="theorie-content">
			...
			<p>Je volgt spoor A.</p>

			<p>Je volgt spoor B.</p>

			<p>Je maakt geen keuze.</p>
			...
			<p>A: vijf mensen,                           B: zes mensen.</p>

			<p>A: een jong kind,                        B: 5 gepensioneerde leraren..</p>

			<p>A: Koning Willem-Alexander,     B: Een geschiedenis student.</p>

			<p>A: Een natuurkunde professor,  B: Een ICT professor.</p>

			<p>A: Jouw ouders,                         B: 30 onschuldige mensen.</p>
			...
			<p>A: Tegen een boom aan botsen, riskeer de familie en red de kinderen of</p>

			<p>B: Probeer uit te wijken, riskeer de kinderen aan te botsen.</p>
			...
			<p>-Mensen krijgen een lagere telling gebaseerd op hun contributie in de maatschappij.</p>

			<p>Zo kan je natuurlijk doorgaan, begin met de nutteloze mensen, ga door met de ladder totdat je een hele regelboek hebt bedacht voor jouw Tesla. Nu is het tijd om het in de praktijk uit te testen. Laten we hiervoor de A&B vragen nemen die hiervoor zijn gesteld. We gaan hierbij vanuit dat de kant dat de Tesla besluit om over te rijden absoluut dood tegengaat.</p>

			<p>A: vijf mensen,                           B: zes mensen.</p>

			<p>A: een jong kind,                        B: 5 gepensioneerde werkers.</p>
			...
			<p>A, simpele volging van de eerste regel, probeer zo weinig mogelijk mensen te doden.</p>

			<p>B, hoewel je bij deze keuze meer mensen dood zijn de mensen niet meer nuttig voor de samenleving, het kind heeft een kans om de volgende Einstein worden.</p>

			<p>?, hoe nuttig is de koning is een constitutioneel monarchie? Hoe nuttig is een leerling geschiedenis?</p>

			<p>?, wat is een belangrijkere vak, natuurkunde of informatica? Wat is belangrijker voor de toekomst van de mens?</p>

			<p>B, jouw ouders kunnen wel belangrijk zijn, maar de kans voor nuttige mensen in de dertig onschuldige mensen is veel hoger en daarom is het beter om hun leven te redden?</p>
