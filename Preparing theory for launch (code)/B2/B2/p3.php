...
<body>
	...
	<div class="theorie">
		...
		<div class="theorie-content">
			...
			<p>Gebruik firefox als browser</p>

			<p>Gebruik een VPN</p>

			<p>Gebruik ecosia of duckduckgo als zoekmachine</p>

			<p>Geef geen onnodige informatie af</p>

			<p>Let op met sociale media</p>
		...
		<div class="theorie-content">
			<ol>
				<li>Denk na over hoe belangrijk privacy voor jou is.

Neem eventueel maatregelingen om jouw online privacy te verbeteren.

Vraag voor een service jouw gegevens op. Dit kan voor Google via https://takeout.google.com/settings/takeout/downloads voor Apple via privacy.apple.com en voor Facebook via <a href="https://www.facebook.com/dyi</li>">https://www.facebook.com/dyi</li></a>
			</ol>
		</div>
	</div>
