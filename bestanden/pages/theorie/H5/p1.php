...
<body>
	...
	<div class="theorie">
		...
		<div class="theorie-content">
			<pre>
In dit hoofdstuk ga je leren hoe je een (eenvoudige) website kunt maken. Hiervoor leer je HTML en CSS. HTML is voor de inhoud van de pagina en CSS voor de opmaak (het goed uit laten zien van de site).
