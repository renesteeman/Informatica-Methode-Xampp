...
<body>
	...
	<div class="theorie">
		...
		<div class="theorie-content">
			<ol>
				<li>Wat is het verschil tussen een IP- en MAC-adres?

Wat is de functie van een DHCP-server?

Noem 1 methode om de beveiliging van een verbinding te verbeteren.</li>
			</ol>
		</div>
		...
		<div class="theorie-content theorie-answers">
			<ol>
				<li>Een MAC-adres is een adres dat gekoppeld is aan een fysieke kaart, terwijl een IP-adres dynamisch wordt verleend. Hiernaast kan er geen data direct naar een MAC-adres gestuurd worden, terwijl dit bij een IP-adres wel kan.

Een DHCP-server deelt IP-adressen uit aan apparaten die met zijn netwerk zijn verbonden.

Het toepassen van encryptie of het verifiëren van verbonden apparaten. (andere antwoorden zijn mogelijk)</li>
			</ol>
		</div>
	</div>
