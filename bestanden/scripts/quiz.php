<?php
	...
	if($hoofdstuk == "H5"){
		$juisteAntwoorden = ['Om zaken zo duidelijk mogelijk te verwoorden.', 'Er wordt gecontroleerd of alles werkt.', 'Het project documenteren.', 'kosten besparen', 'features', 'een overzicht van hoeveel werk nog over is'];
		$uitleg = ['Het wordt gebruikt om zo duidelijk mogelijk te communiceren en misverstanden te voorkomen.', 'De controle van het product vind plaats op het eind van de ontwikkelfase, voordat de klant het product ontvangt.', 'De documentatie wordt door de administrateur geregeld.', 'Agile gaat om beter werken en een beter product maken, het is vaak goedkoper of winstgevender, maar dit is niet het doel van Agile.', 'User stories zijn de functies van het product, deze hoeven nog niet af te zijn.', 'Een burn-down chart geeft weer hoeveel werk (in uren) er nog over is en hoe dit (is) veranderd over een bepaalde tijd. Het is mogelijk dat dit als hulpmiddel om af te vallen werkt als de grafiek niet daalt.'];
	}
