...
<body>
	...
	<div class="theorie">
		...
		<div class="theorie-content">
			...
			<p>In dit hoofdstuk ga je leren hoe je logica kunt toevoegen aan jouw website. In plaats van een site waar je alleen dingen kunt bekijken, kun je er nu ook interactie aan toevoegen. In dit deel van web logic gaan we voornamelijk in op JS (javascript).</p>
			...
			<p>Er zijn naast JS nog veel andere talen die je kunt gebruiken voor websites. JS is wel een van de meest gebruikte en wordt als een van de standaarden van het internet gezien. Een andere veergebruikte taal is PHP. PHP wordt gebruikt om logica uit te voeren op een server en is een erg krachtige, maar soms lastige taal.</p>
			...
			<p>NB: JS kan ook server-side gebruikt worden, maar dat is niet standaard.</p>
