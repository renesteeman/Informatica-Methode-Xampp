	...
	<div class="theorie">
		...
		<div class="theorie-content">
			<p>
				<ol>
					<li>
						Ga naar <a href="https://www.apachefriends.org/index.html">https://www.apachefriends.org/index.html</a> en download XAMPP.
					</li>
					<li>
						Start de XAMPP installeer en volg de stappen en installeer alle onderdelen.
					</li>
					<li>
